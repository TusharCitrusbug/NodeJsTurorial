...
router.post('/users', auth, superUserAuth, controllers.create_user)

router.get('/users', auth, controllers.list_user)

router.get('/users/:id', auth, superUserAuth, controllers.get_user_by_id)
...
// delete user
router.delete('/users/:id', auth, superUserAuth, controllers.delete_user)
